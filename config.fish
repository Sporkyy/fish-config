...
if status is-interactive
    ...
    if test "$TERM_PROGRAM" = vscode
        ...
        if test "$os" = Darwin
            set vscode_shell_integration "/Applications/Visual Studio Code.app/Contents/Resources/app/out/vs/workbench/contrib/terminal/common/scripts/shellIntegration.fish"
            ...
            set vscode_shell_integration "/usr/share/code/resources/app/out/vs/workbench/contrib/terminal/common/scripts/shellIntegration.fish"
            if not test -f "$vscode_shell_integration"
